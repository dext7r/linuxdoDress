  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="403错误页面 - 您的权限不足，无法访问此资源，请联系管理员申请相应权限。" />
        <meta name="keywords" content="403错误, 禁止访问, 权限不足, 访问被拒绝, 权限申请" />
        <meta property="og:title" content="403 - 禁止访问 | Athena Template" />
        <meta property="og:description" content="403错误页面 - 您的权限不足，无法访问此资源，请联系管理员申请相应权限。" />
      ...
      <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-white to-red-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-32 w-80 h-80 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
          <div className="absolute -bottom-40 -left-32 w-80 h-80 bg-red-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
          <div className="absolute top-40 left-40 w-80 h-80 bg-orange-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
        </div>
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="mb-8 flex justify-center">
              <div className="relative">
                ...
                <div className="absolute inset-0 w-32 h-32 border-4 border-yellow-200 dark:border-yellow-800 rounded-full animate-ping"></div>
              </div>
            </div>
            ...
            <div className="mt-8 text-sm text-gray-500 dark:text-gray-400">
              ...
              <p className="mt-1">
                技术支持: <a href="mailto:h7ml@qq.com" className="text-yellow-600 dark:text-yellow-400 hover:underline">h7ml@qq.com</a>
              </p>
            </div>
          </div>
        </div>
