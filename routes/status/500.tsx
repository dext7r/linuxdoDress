  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="500错误页面 - 服务器遇到意外情况无法完成请求，我们正在努力修复这个问题。" />
        <meta name="keywords" content="500错误, 服务器错误, 内部错误, 系统故障, 技术支持" />
        <meta property="og:title" content="500 - 服务器错误 | Athena Template" />
        <meta property="og:description" content="500错误页面 - 服务器遇到意外情况无法完成请求，我们正在努力修复这个问题。" />
