  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="503错误页面 - 服务器暂时过载或维护中无法处理请求，请稍后重试。" />
        <meta name="keywords" content="503错误, 服务不可用, 服务器维护, 系统过载, 暂时不可用" />
        <meta property="og:title" content="503 - 服务不可用 | Athena Template" />
        <meta property="og:description" content="503错误页面 - 服务器暂时过载或维护中无法处理请求，请稍后重试。" />
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="mb-8 flex justify-center">
              <div className="relative">
                ...
                <div className="absolute inset-0 w-32 h-32 border-4 border-purple-200 dark:border-purple-800 rounded-full animate-ping"></div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 backdrop-blur-sm bg-opacity-80 dark:bg-opacity-80 mb-8">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300 space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <span>预计完成:</span>
                  <span className="text-purple-600 dark:text-purple-400">约30分钟</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>影响范围:</span>
                  <span>全部服务</span>
