  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="展示常见的HTTP错误状态码页面设计，包括401、403、404、500、502、503等状态码的用户友好页面。" />
        <meta name="keywords" content="HTTP状态码, 错误页面, 401, 403, 404, 500, 502, 503, 用户体验" />
        <meta property="og:title" content="HTTP状态码演示 - Athena Template" />
        <meta property="og:description" content="展示常见的HTTP错误状态码页面设计，包括401、403、404、500、502、503等状态码的用户友好页面。" />
      ...
      <Layout title="HTTP状态码演示">
        <div className="space-y-16">
          ...
          <div className="relative overflow-hidden">
            {/* 背景装饰 */}
            <div className="absolute inset-0 bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50 dark:from-gray-900 dark:via-yellow-900/20 dark:to-orange-900/20"></div>
            <div className="absolute inset-0">
              <div className="absolute top-0 left-1/4 w-64 h-64 bg-yellow-400/10 rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
              <div className="absolute top-0 right-1/4 w-64 h-64 bg-orange-400/10 rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-2000"></div>
            </div>
            ...
            <div className="relative text-center space-y-6 py-16 px-4">
              ...
              <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed">
                展示常见的 <span className="font-semibold text-yellow-600 dark:text-yellow-400">HTTP错误状态码</span> 页面设计，
                包括 <span className="font-semibold text-orange-600 dark:text-orange-400">401、403、404、500、502、503</span> 等状态码的用户友好页面
              </p>
            </div>
          </div>
                ...
                <Card className="h-full transition-all duration-300 hover:shadow-xl hover:scale-105 group-hover:shadow-2xl">
                  <CardHeader className={`${status.bgColor} rounded-t-lg`}>
                    <div className="flex items-center justify-between">
                      ...
                      <div className={`text-2xl font-bold bg-gradient-to-r ${status.color} bg-clip-text text-transparent`}>
                        {status.code}
                      </div>
                    </div>
                  </CardHeader>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-2">4xx 客户端错误</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white mb-2">5xx 服务器错误</h4>
                    <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                      <li>• 500 - 服务器内部错误</li>
                      <li>• 502 - 网关错误</li>
                      <li>• 503 - 服务不可用</li>
