  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="401错误页面 - 您没有权限访问此资源，请登录后重试或联系管理员获取权限。" />
        <meta name="keywords" content="401错误, 未授权访问, 权限不足, 登录, 访问被拒绝" />
        <meta property="og:title" content="401 - 未授权访问 | Athena Template" />
        <meta property="og:description" content="401错误页面 - 您没有权限访问此资源，请登录后重试或联系管理员获取权限。" />
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-32 w-80 h-80 bg-red-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
          <div className="absolute -bottom-40 -left-32 w-80 h-80 bg-orange-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="mb-8 flex justify-center">
              <div className="relative">
                ...
                <div className="absolute inset-0 w-32 h-32 border-4 border-red-200 dark:border-red-800 rounded-full animate-ping"></div>
              </div>
            </div>
            ...
            <div className="mt-8 text-sm text-gray-500 dark:text-gray-400">
              ...
              <p className="mt-1">
                技术支持: <a href="mailto:h7ml@qq.com" className="text-red-600 dark:text-red-400 hover:underline">h7ml@qq.com</a>
              </p>
            </div>
          </div>
        </div>
