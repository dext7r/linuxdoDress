  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="502错误页面 - 作为网关的服务器从上游服务器收到无效响应，请稍后重试。" />
        <meta name="keywords" content="502错误, 网关错误, 服务器错误, 网络故障, 连接问题" />
        <meta property="og:title" content="502 - 网关错误 | Athena Template" />
        <meta property="og:description" content="502错误页面 - 作为网关的服务器从上游服务器收到无效响应，请稍后重试。" />
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-32 w-80 h-80 bg-orange-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="mb-8 flex justify-center">
              <div className="relative">
                ...
                <div className="absolute inset-0 w-32 h-32 border-4 border-orange-200 dark:border-orange-800 rounded-full animate-ping"></div>
              </div>
            </div>
            ...
            <div className="mt-8 text-sm text-gray-500 dark:text-gray-400">
              ...
              <p className="mt-1">
                技术支持: <a href="mailto:h7ml@qq.com" className="text-orange-600 dark:text-orange-400 hover:underline">h7ml@qq.com</a>
              </p>
