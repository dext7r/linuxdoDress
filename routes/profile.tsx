        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="text-center py-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
              管理您的个人信息和账户设置，查看您的 GitHub 统计数据，掌控您的数字身份
            </p>

            {/* 装饰性分割线 */}
            <div className="flex items-center justify-center mt-8">
              <div className="h-px bg-gradient-to-r from-transparent via-gray-300 dark:via-gray-600 to-transparent w-64"></div>
              <div className="mx-4 w-2 h-2 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full"></div>
              <div className="h-px bg-gradient-to-r from-transparent via-gray-300 dark:via-gray-600 to-transparent w-64"></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="relative px-6 pb-8">
                  ...
                  <div className="flex justify-center -mt-14 sm:-mt-18 mb-6">
                    <div className="relative group/avatar">
                      {/* 头像光环 */}
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full blur-md opacity-75 group-hover/avatar:opacity-100 transition-opacity duration-300"></div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-gray-600 dark:text-gray-400">显示名称</span>
                          <span className="text-sm font-medium text-gray-900 dark:text-white">
                            {user.name || "未设置"}
                          </span>
                        </div>
                    ...
                    {/* GitHub 附加信息 */}
                    {(user.bio || user.location || user.company || user.website) && (
                      <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                        <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-3 flex items-center">
                          <svg className="w-4 h-4 mr-2 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                          </svg>
                          GitHub 信息
                        </h3>
                        ...
                        <div className="space-y-3">
                          {user.bio && (
                            <div>
                              <span className="text-sm text-gray-600 dark:text-gray-400 block mb-1">个人简介</span>
            ...
            <div className="lg:col-span-2 space-y-6">
              {/* GitHub 统计卡片 */}
              {(user.publicRepos !== undefined || user.followers !== undefined || user.following !== undefined) && (
