          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="mb-8 flex justify-center">
              <div className="relative">
                ...
                {/* 装饰圆环 */}
                <div className="absolute inset-0 w-32 h-32 border-4 border-blue-200 dark:border-blue-800 rounded-full animate-ping"></div>
              </div>
            </div>
            ...
            <div className="mt-8 text-sm text-gray-500 dark:text-gray-400">
              ...
              <p className="mt-1">
                <a href="mailto:h7ml@qq.com" className="text-blue-600 dark:text-blue-400 hover:underline">
                  h7ml@qq.com
                </a>
              </p>
            </div>
